...
const SHELL=['./','./index.html','./styles.css','./search-mode.css','./file-index.css','./equipment-register.css','./operator-session.css','./theme-control.css','./tts-control.css','./app.js','./search-mode.js','./file-index.js','./matches-export.js','./equipment-register.js','./equipment-process.js','./equipment-capacity.js','./equipment-entry-flow.js','./equipment-access-import.js','./equipment-auto-focus.js','./equipment-input-lock.js','./operator-session.js','./operator-lock.js','./operator-counter-fix.js','./equipment-box-print.js','./registry-export.js','./audit-fixes.js','./unified-export.js','./export-summary.js','./voice-notifications.js','./config.js','./production-core.js','./cloud-session.js','./app-integration.js','./admin-panel.js','./manifest.json','./icon.svg'];
